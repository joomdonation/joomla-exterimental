...
use Joomla\CMS\Event\User as UserEvent;
        ...
        foreach ($pks as $i => $pk) {
            if ($table->load($pk)) {
                ...
                if ($allow) {
                    ...
                    $dispatcher->dispatch($this->event_before_delete, new UserEvent\BeforeDeleteEvent($this->event_before_delete, [
                    ...
                    $dispatcher->dispatch($this->event_after_delete, new UserEvent\AfterDeleteEvent($this->event_after_delete, [
            ...
            if ($value == 1 && $pk == $user->id) {
                ...
                if ($allow) {
                    ...
                    try {
                        ...
                        $result = $dispatcher->dispatch($this->event_before_save, new UserEvent\BeforeSaveEvent($this->event_before_save, [
                            'subject' => $old,
                            'isNew'   => false,
                        ...
                        $dispatcher->dispatch($this->event_after_save, new UserEvent\AfterSaveEvent($this->event_after_save, [
                            'subject'        => $table->getProperties(),
                            'isNew'          => false,
                            'savingResult'   => true,
                            'errorMessage'   => null,
